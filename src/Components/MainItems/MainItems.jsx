    ...
    <>
      <div className="z-10 flexDisplay flex-wrap">
        {MainItemsData?.map((item) => (
          <div key={item.id} className="p-2 w-[370px]">
            <div className="w-full">
              {item.Special.length > 0 ? (
                item.Special.map((special, index) => (
                  <div className="w-full gap-3 bg-white px-4 " key={index}>
                    <div className="leading-[60px] font-bold text-[18px]">
                      {item.title}
                        </div>
                        <img src={special.src } alt="" className="h-[251px]" />
                    <a
                      href="#"
                ...
                <div className="w-full gap-3 bg-white px-4">
                  ...
                  <div className="flex flex-wrap gap-y-6 gap-x-3">
                    <a className="w-[48%]">
                      ...
                      <p className="text-[12px]">{item.text1}</p>
                    </a>
                    <a className="w-[48%]">
                      <img src={item.img2} alt="" width="180" height="110" />
                      <p className="text-[12px]">{item.text2}</p>
                    </a>
                    <a className="w-[48%]">
                      <img src={item.img3} alt="" width="180" height="110" />
                      <p className="text-[12px]">{item.text3}</p>
                    </a>
                    <a className="w-[48%]">
                      <img src={item.img4} alt="" width="180" height="110" />
                      <p className="text-[12px]">{item.text4}</p>
                    </a>
                  </div>
                  <a
                    href="#"
